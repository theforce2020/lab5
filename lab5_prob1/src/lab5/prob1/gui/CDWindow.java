...
public class CDWindow extends JFrame {
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
			String artt = artistField.getText();
			String ttl = titleField.getText();
			String pr = priceField.getText();
			
			try {
				RuleSet rls = RuleSetFactory.getRuleSet(CDWindow.this); 
				rls.applyRules(CDWindow.this);
				String output = "Artist: "+artt + "\nTitle: " + ttl + "\nPrice: " + pr;
